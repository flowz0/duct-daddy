  ...
  return (
    <div className="flex flex-col">
      ...
      <div className={`text-[#333333] mt-2 rounded-lg outline-none flex items-center gap-x-4 w-fit `}>
        <label
          htmlFor={name}
          className={`cursor-pointer bg-[#0080DB] text-white px-4 py-2 rounded-md font-medium hover:bg-[#006bbf] ${error ? "ring-2 ring-offset-2 ring-red-500" : "focus:ring-2 focus:ring-offset-2 focus:ring-[#0080DB]"
            }`}
        >
          Choose image
        </label>
