...
export default function Hero() {
  return (
    <section className="py-28 px-6 max-w-7xl mx-auto flex flex-col items-center gap-8 md:flex-row">
      <header className="flex flex-col items-center md:w-1/2 md:items-start">
        <h1 className="text-3xl font-semibold max-w-sm text-center sm:text-4xl md:text-start">
